...
//        users = in.createTypedArrayList(com.dreams.chat.models.User.CREATOR);
        date = in.readLong();
        ArrayList<String> exitUserIds = in.createStringArrayList();
        grpExitUserIds = new RealmList<>();
        grpExitUserIds.addAll(exitUserIds);
        //ArrayList<com.dreams.chat.models.MyString> exitIdsToParse = in.createTypedArrayList(com.dreams.chat.models.MyString.CREATOR);
//        exitIDS = new RealmList<>();
//        if (exitIdsToParse != null)
//            exitIDS.addAll(exitIdsToParse);
    }
...
//        ArrayList<com.dreams.chat.models.MyString> exitIdsToParse = new ArrayList<>();
//        exitIdsToParse.addAll(this.exitIDS);
//        parcel.writeTypedList(exitIdsToParse);
    }
