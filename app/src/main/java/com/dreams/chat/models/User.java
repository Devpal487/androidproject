...
public class User implements Parcelable, RealmModel {
    ...
    private String id, name, status, image, pincode ,statename ,membername;
    ...
    public User(String id, String name, String status, String image, String statename, String membername, String pincode) {
        this.id = id;
        this.name = name;
        this.status = status;
        this.online = false;
