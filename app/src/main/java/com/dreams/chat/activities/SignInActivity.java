...
import com.dreams.chat.models.Country;
import com.dreams.chat.models.User;
import com.dreams.chat.utils.Helper;
import com.dreams.chat.utils.KeyboardUtil;
    ...
    private void stateviewbind() {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter=new ArrayAdapter<>(SignInActivity.this,android.R.layout.simple_list_item_1,statearrayList);
...
//                        retryTimer.setVisibility(View.GONE);
    ...
    private void login() {
        authInProgress = true;
      //  phoneNumberInPrefs="+919125918348";
        BaseApplication.getUserRef().child(phoneNumberInPrefs).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    ...
                    pinocde=  sharedpreferences.getString("pinocde",null);
                    membername=  sharedpreferences.getString("membername",null);
                    try {
                        ...
                        if (User.validate(user)) {
                            ...
                            pinocde=  sharedpreferences.getString("pinocde",null);
                            membername=  sharedpreferences.getString("membername",null);
                            createUser(new User(phoneNumberInPrefs, phoneNumberInPrefs, getString(R.string.app_name), "",statename,membername,pinocde));
                        }
                    } catch (Exception ex) {
                        sharedpreferences = getSharedPreferences(MyPREFERENCES,MODE_PRIVATE);
                        statename=  sharedpreferences.getString("statename",null);
    ...
    public void submit() {
        ...
        try {
           /* if (spinnerCountryCodes.getSelectedItem() == null || (myCountryCodeTXT.getText().toString().trim().equalsIgnoreCase(""))) {
            ...
            statename_view =findViewById(R.id.statename_view);
            statename=  statename_view.getText().toString();
            pincode_edit =findViewById(R.id.pincode);
            pinocde=  pincode_edit.getText().toString();
            username_edit =findViewById(R.id.username);
            membername=  username_edit.getText().toString();
            ...
            if (TextUtils.isEmpty(pinocde)) {
                Toast.makeText(this, "Enter Pincode number!", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            editor.putString("pinocde", pinocde);
           ...
           // login();
            ...
            final String phoneNumber = "+91" + etPhone.getText().toString().replaceAll("\\s+", "");
