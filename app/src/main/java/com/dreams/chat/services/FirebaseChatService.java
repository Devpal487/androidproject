...
import com.dreams.chat.models.MessageNewArrayList;
import com.dreams.chat.models.MyString;
import com.dreams.chat.models.Status;
import com.dreams.chat.models.StatusImage;
import com.dreams.chat.models.StatusImageList;
import com.dreams.chat.models.StatusImageNew;
import com.dreams.chat.models.StatusNew;
...
public class FirebaseChatService extends Service {
    ...
    public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID_MAIN, "HotRaga service", NotificationManager.IMPORTANCE_LOW);
