...
public class com_dreams_chat_models_StatusNewRealmProxy extends com.dreams.chat.models.StatusNew
    implements RealmObjectProxy, com_dreams_chat_models_StatusNewRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.StatusNew> proxyState;
    private RealmList<com.dreams.chat.models.StatusImageNew> statusImagesRealmList;

    com_dreams_chat_models_StatusNewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.StatusNew>(this);
    ...
    @Override
    public RealmList<com.dreams.chat.models.StatusImageNew> realmGet$statusImages() {
        ...
        if (statusImagesRealmList != null) {
            ...
            statusImagesRealmList = new RealmList<com.dreams.chat.models.StatusImageNew>(com.dreams.chat.models.StatusImageNew.class, osList, proxyState.getRealm$realm());
            return statusImagesRealmList;
        }
    }

    @Override
    public void realmSet$statusImages(RealmList<com.dreams.chat.models.StatusImageNew> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.dreams.chat.models.StatusImageNew> original = value;
                value = new RealmList<com.dreams.chat.models.StatusImageNew>();
                for (com.dreams.chat.models.StatusImageNew item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.dreams.chat.models.StatusImageNew linkedObject = value.get(i);
    ...
    public com.dreams.chat.models.User realmGet$user() {
        ...
        return proxyState.getRealm$realm().get(com.dreams.chat.models.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.dreams.chat.models.Group realmGet$group() {
        ...
        return proxyState.getRealm$realm().get(com.dreams.chat.models.Group.class, proxyState.getRow$realm().getLink(columnInfo.groupIndex), false, Collections.<String>emptyList());
    }
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.StatusNew createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.dreams.chat.models.StatusNew obj = realm.createObjectInternal(com.dreams.chat.models.StatusNew.class, true, excludeFields);

        final com_dreams_chat_models_StatusNewRealmProxyInterface objProxy = (com_dreams_chat_models_StatusNewRealmProxyInterface) obj;
        if (json.has("statusImages")) {
            if (json.isNull("statusImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.dreams.chat.models.StatusImageNew item = com_dreams_chat_models_StatusImageNewRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.dreams.chat.models.User userObj = com_dreams_chat_models_UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("group")) {
            if (json.isNull("group")) {
                ...
                com.dreams.chat.models.Group groupObj = com_dreams_chat_models_GroupRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("group"), update);
    ...
    public static com.dreams.chat.models.StatusNew createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.StatusNew obj = new com.dreams.chat.models.StatusNew();
        final com_dreams_chat_models_StatusNewRealmProxyInterface objProxy = (com_dreams_chat_models_StatusNewRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$statusImages(new RealmList<com.dreams.chat.models.StatusImageNew>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.dreams.chat.models.StatusImageNew item = com_dreams_chat_models_StatusImageNewRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$statusImages().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.dreams.chat.models.User userObj = com_dreams_chat_models_UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$user(userObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.dreams.chat.models.Group groupObj = com_dreams_chat_models_GroupRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$group(groupObj);
                }
    ...
    public static com.dreams.chat.models.StatusNew copyOrUpdate(Realm realm, com.dreams.chat.models.StatusNew object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.StatusNew) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.StatusNew copy(Realm realm, com.dreams.chat.models.StatusNew newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.StatusNew realmObject = realm.createObjectInternal(com.dreams.chat.models.StatusNew.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_StatusNewRealmProxyInterface realmObjectSource = (com_dreams_chat_models_StatusNewRealmProxyInterface) newObject;
        com_dreams_chat_models_StatusNewRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_StatusNewRealmProxyInterface) realmObject;


        RealmList<com.dreams.chat.models.StatusImageNew> statusImagesList = realmObjectSource.realmGet$statusImages();
        if (statusImagesList != null) {
            RealmList<com.dreams.chat.models.StatusImageNew> statusImagesRealmList = realmObjectCopy.realmGet$statusImages();
            statusImagesRealmList.clear();
            for (int i = 0; i < statusImagesList.size(); i++) {
                com.dreams.chat.models.StatusImageNew statusImagesItem = statusImagesList.get(i);
                com.dreams.chat.models.StatusImageNew cachestatusImages = (com.dreams.chat.models.StatusImageNew) cache.get(statusImagesItem);
                if (cachestatusImages != null) {
                    statusImagesRealmList.add(cachestatusImages);
                } else {
                    statusImagesRealmList.add(com_dreams_chat_models_StatusImageNewRealmProxy.copyOrUpdate(realm, statusImagesItem, update, cache));
                }
            }
        }
        ...
        com.dreams.chat.models.User userObj = realmObjectSource.realmGet$user();
        if (userObj == null) {
            realmObjectCopy.realmSet$user(null);
        } else {
            com.dreams.chat.models.User cacheuser = (com.dreams.chat.models.User) cache.get(userObj);
            if (cacheuser != null) {
                realmObjectCopy.realmSet$user(cacheuser);
            } else {
                realmObjectCopy.realmSet$user(com_dreams_chat_models_UserRealmProxy.copyOrUpdate(realm, userObj, update, cache));
            }
        }

        com.dreams.chat.models.Group groupObj = realmObjectSource.realmGet$group();
        if (groupObj == null) {
            realmObjectCopy.realmSet$group(null);
        } else {
            com.dreams.chat.models.Group cachegroup = (com.dreams.chat.models.Group) cache.get(groupObj);
            if (cachegroup != null) {
                realmObjectCopy.realmSet$group(cachegroup);
            } else {
                realmObjectCopy.realmSet$group(com_dreams_chat_models_GroupRealmProxy.copyOrUpdate(realm, groupObj, update, cache));
            }
        }
    ...
    public static long insert(Realm realm, com.dreams.chat.models.StatusNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusNew.class);
        long tableNativePtr = table.getNativePtr();
        StatusNewColumnInfo columnInfo = (StatusNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusNew.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.dreams.chat.models.StatusImageNew> statusImagesList = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$statusImages();
        if (statusImagesList != null) {
            OsList statusImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.statusImagesIndex);
            for (com.dreams.chat.models.StatusImageNew statusImagesItem : statusImagesList) {
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_dreams_chat_models_StatusImageNewRealmProxy.insert(realm, statusImagesItem, cache);
                }
                statusImagesOsList.addRow(cacheItemIndexstatusImages);
            }
        }
        String realmGet$lastMessage = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$timeUpdated(), false);

        com.dreams.chat.models.User userObj = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
            Long cacheuser = cache.get(userObj);
            if (cacheuser == null) {
                cacheuser = com_dreams_chat_models_UserRealmProxy.insert(realm, userObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.userIndex, rowIndex, cacheuser, false);
        }

        com.dreams.chat.models.Group groupObj = ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_dreams_chat_models_GroupRealmProxy.insert(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupIndex, rowIndex, cachegroup, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_dreams_chat_models_StatusNewRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusNewColumnInfo columnInfo = (StatusNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusNew.class);
        com.dreams.chat.models.StatusNew object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.StatusNew) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.StatusNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusNew.class);
        ...
        if (statusImagesList != null && statusImagesList.size() == statusImagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_dreams_chat_models_StatusImageNewRealmProxy.insertOrUpdate(realm, statusImagesItem, cache);
                }
        ...
        if (userObj != null) {
            Long cacheuser = cache.get(userObj);
            if (cacheuser == null) {
                cacheuser = com_dreams_chat_models_UserRealmProxy.insertOrUpdate(realm, userObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.userIndex, rowIndex, cacheuser, false);
        } else {
        ...
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_dreams_chat_models_GroupRealmProxy.insertOrUpdate(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupIndex, rowIndex, cachegroup, false);
        } else {
    ...
    public static com.dreams.chat.models.StatusNew createDetachedCopy(com.dreams.chat.models.StatusNew realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.StatusNew unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.StatusNew();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.StatusNew) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.StatusNew) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_StatusNewRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_StatusNewRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_StatusNewRealmProxyInterface realmSource = (com_dreams_chat_models_StatusNewRealmProxyInterface) realmObject;

        // Deep copy of statusImages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$statusImages(null);
        } else {
            RealmList<com.dreams.chat.models.StatusImageNew> managedstatusImagesList = realmSource.realmGet$statusImages();
            RealmList<com.dreams.chat.models.StatusImageNew> unmanagedstatusImagesList = new RealmList<com.dreams.chat.models.StatusImageNew>();
            unmanagedCopy.realmSet$statusImages(unmanagedstatusImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedstatusImagesList.size();
            for (int i = 0; i < size; i++) {
                com.dreams.chat.models.StatusImageNew item = com_dreams_chat_models_StatusImageNewRealmProxy.createDetachedCopy(managedstatusImagesList.get(i), nextDepth, maxDepth, cache);
        ...
        // Deep copy of user
        unmanagedCopy.realmSet$user(com_dreams_chat_models_UserRealmProxy.createDetachedCopy(realmSource.realmGet$user(), currentDepth + 1, maxDepth, cache));

        // Deep copy of group
        unmanagedCopy.realmSet$group(com_dreams_chat_models_GroupRealmProxy.createDetachedCopy(realmSource.realmGet$group(), currentDepth + 1, maxDepth, cache));
    ...
    public boolean equals(Object o) {
        ...
        com_dreams_chat_models_StatusNewRealmProxy aStatusNew = (com_dreams_chat_models_StatusNewRealmProxy)o;
