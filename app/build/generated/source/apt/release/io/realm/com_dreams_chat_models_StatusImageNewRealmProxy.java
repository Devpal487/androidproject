...
public class com_dreams_chat_models_StatusImageNewRealmProxy extends com.dreams.chat.models.StatusImageNew
    implements RealmObjectProxy, com_dreams_chat_models_StatusImageNewRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.StatusImageNew> proxyState;

    com_dreams_chat_models_StatusImageNewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.StatusImageNew>(this);
    ...
    @Override
    public com.dreams.chat.models.AttachmentList realmGet$attachment() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.attachmentIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.dreams.chat.models.AttachmentList.class, proxyState.getRow$realm().getLink(columnInfo.attachmentIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$attachment(com.dreams.chat.models.AttachmentList value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.StatusImageNew createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        com.dreams.chat.models.StatusImageNew obj = realm.createObjectInternal(com.dreams.chat.models.StatusImageNew.class, true, excludeFields);

        final com_dreams_chat_models_StatusImageNewRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                com.dreams.chat.models.AttachmentList attachmentObj = com_dreams_chat_models_AttachmentListRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
    ...
    public static com.dreams.chat.models.StatusImageNew createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.StatusImageNew obj = new com.dreams.chat.models.StatusImageNew();
        final com_dreams_chat_models_StatusImageNewRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.dreams.chat.models.AttachmentList attachmentObj = com_dreams_chat_models_AttachmentListRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$attachment(attachmentObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.dreams.chat.models.StatusImageNew copyOrUpdate(Realm realm, com.dreams.chat.models.StatusImageNew object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.StatusImageNew) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.StatusImageNew copy(Realm realm, com.dreams.chat.models.StatusImageNew newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.StatusImageNew realmObject = realm.createObjectInternal(com.dreams.chat.models.StatusImageNew.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_StatusImageNewRealmProxyInterface realmObjectSource = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) newObject;
        com_dreams_chat_models_StatusImageNewRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) realmObject;
        ...
        com.dreams.chat.models.AttachmentList attachmentObj = realmObjectSource.realmGet$attachment();
        if (attachmentObj == null) {
            realmObjectCopy.realmSet$attachment(null);
        } else {
            com.dreams.chat.models.AttachmentList cacheattachment = (com.dreams.chat.models.AttachmentList) cache.get(attachmentObj);
            if (cacheattachment != null) {
                realmObjectCopy.realmSet$attachment(cacheattachment);
            } else {
                realmObjectCopy.realmSet$attachment(com_dreams_chat_models_AttachmentListRealmProxy.copyOrUpdate(realm, attachmentObj, update, cache));
            }
        }
        return realmObject;
    }

    public static long insert(Realm realm, com.dreams.chat.models.StatusImageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImageNew.class);
        long tableNativePtr = table.getNativePtr();
        StatusImageNewColumnInfo columnInfo = (StatusImageNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImageNew.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$id = ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.dreams.chat.models.AttachmentList attachmentObj = ((com_dreams_chat_models_StatusImageNewRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_dreams_chat_models_AttachmentListRealmProxy.insert(realm, attachmentObj, cache);
            }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusImageNewColumnInfo columnInfo = (StatusImageNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImageNew.class);
        com.dreams.chat.models.StatusImageNew object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.StatusImageNew) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.StatusImageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImageNew.class);
        ...
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_dreams_chat_models_AttachmentListRealmProxy.insertOrUpdate(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        } else {
    ...
    public static com.dreams.chat.models.StatusImageNew createDetachedCopy(com.dreams.chat.models.StatusImageNew realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.StatusImageNew unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.StatusImageNew();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.StatusImageNew) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.StatusImageNew) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_StatusImageNewRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_StatusImageNewRealmProxyInterface realmSource = (com_dreams_chat_models_StatusImageNewRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$attachment(com_dreams_chat_models_AttachmentListRealmProxy.createDetachedCopy(realmSource.realmGet$attachment(), currentDepth + 1, maxDepth, cache));
