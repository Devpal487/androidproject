...
public class com_dreams_chat_models_ChatRealmProxy extends com.dreams.chat.models.Chat
    implements RealmObjectProxy, com_dreams_chat_models_ChatRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.Chat> proxyState;
    private RealmList<com.dreams.chat.models.Message> messagesRealmList;

    com_dreams_chat_models_ChatRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.Chat>(this);
    ...
    public RealmList<com.dreams.chat.models.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.dreams.chat.models.Message>(com.dreams.chat.models.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.dreams.chat.models.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.dreams.chat.models.Message> original = value;
                value = new RealmList<com.dreams.chat.models.Message>();
                for (com.dreams.chat.models.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.dreams.chat.models.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.dreams.chat.models.Chat obj = realm.createObjectInternal(com.dreams.chat.models.Chat.class, true, excludeFields);

        final com_dreams_chat_models_ChatRealmProxyInterface objProxy = (com_dreams_chat_models_ChatRealmProxyInterface) obj;
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.dreams.chat.models.Message item = com_dreams_chat_models_MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.dreams.chat.models.Chat createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.Chat obj = new com.dreams.chat.models.Chat();
        final com_dreams_chat_models_ChatRealmProxyInterface objProxy = (com_dreams_chat_models_ChatRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.dreams.chat.models.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.dreams.chat.models.Message item = com_dreams_chat_models_MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.dreams.chat.models.Chat copyOrUpdate(Realm realm, com.dreams.chat.models.Chat object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.Chat) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.Chat copy(Realm realm, com.dreams.chat.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.Chat realmObject = realm.createObjectInternal(com.dreams.chat.models.Chat.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_ChatRealmProxyInterface realmObjectSource = (com_dreams_chat_models_ChatRealmProxyInterface) newObject;
        com_dreams_chat_models_ChatRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_ChatRealmProxyInterface) realmObject;


        RealmList<com.dreams.chat.models.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.dreams.chat.models.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.dreams.chat.models.Message messagesItem = messagesList.get(i);
                com.dreams.chat.models.Message cachemessages = (com.dreams.chat.models.Message) cache.get(messagesItem);
                if (cachemessages != null) {
                    messagesRealmList.add(cachemessages);
                } else {
                    messagesRealmList.add(com_dreams_chat_models_MessageRealmProxy.copyOrUpdate(realm, messagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.dreams.chat.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Chat.class);
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Chat.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.dreams.chat.models.Message> messagesList = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.dreams.chat.models.Message messagesItem : messagesList) {
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_dreams_chat_models_MessageRealmProxy.insert(realm, messagesItem, cache);
                }
                messagesOsList.addRow(cacheItemIndexmessages);
            }
        }
        String realmGet$lastMessage = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);

        com.dreams.chat.models.User userObj = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        com.dreams.chat.models.Group groupObj = ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_dreams_chat_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Chat.class);
        com.dreams.chat.models.Chat object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.Chat) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Chat.class);
        ...
        if (messagesList != null && messagesList.size() == messagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_dreams_chat_models_MessageRealmProxy.insertOrUpdate(realm, messagesItem, cache);
                }
    ...
    public static com.dreams.chat.models.Chat createDetachedCopy(com.dreams.chat.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.Chat unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.Chat();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.Chat) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.Chat) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_ChatRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_ChatRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_ChatRealmProxyInterface realmSource = (com_dreams_chat_models_ChatRealmProxyInterface) realmObject;

        // Deep copy of messages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$messages(null);
        } else {
            RealmList<com.dreams.chat.models.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.dreams.chat.models.Message> unmanagedmessagesList = new RealmList<com.dreams.chat.models.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.dreams.chat.models.Message item = com_dreams_chat_models_MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_dreams_chat_models_ChatRealmProxy aChat = (com_dreams_chat_models_ChatRealmProxy)o;
