...
public class com_dreams_chat_models_StatusImageRealmProxy extends com.dreams.chat.models.StatusImage
    implements RealmObjectProxy, com_dreams_chat_models_StatusImageRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.StatusImage> proxyState;

    com_dreams_chat_models_StatusImageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.StatusImage>(this);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.StatusImage createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        com.dreams.chat.models.StatusImage obj = realm.createObjectInternal(com.dreams.chat.models.StatusImage.class, true, excludeFields);

        final com_dreams_chat_models_StatusImageRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
    ...
    public static com.dreams.chat.models.StatusImage createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.StatusImage obj = new com.dreams.chat.models.StatusImage();
        final com_dreams_chat_models_StatusImageRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.dreams.chat.models.StatusImage copyOrUpdate(Realm realm, com.dreams.chat.models.StatusImage object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.StatusImage) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.StatusImage copy(Realm realm, com.dreams.chat.models.StatusImage newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.StatusImage realmObject = realm.createObjectInternal(com.dreams.chat.models.StatusImage.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_StatusImageRealmProxyInterface realmObjectSource = (com_dreams_chat_models_StatusImageRealmProxyInterface) newObject;
        com_dreams_chat_models_StatusImageRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_StatusImageRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.dreams.chat.models.StatusImage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImage.class);
        long tableNativePtr = table.getNativePtr();
        StatusImageColumnInfo columnInfo = (StatusImageColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImage.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$id = ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.dreams.chat.models.Attachment attachmentObj = ((com_dreams_chat_models_StatusImageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusImageColumnInfo columnInfo = (StatusImageColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImage.class);
        com.dreams.chat.models.StatusImage object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.StatusImage) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.StatusImage object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImage.class);
    ...
    public static com.dreams.chat.models.StatusImage createDetachedCopy(com.dreams.chat.models.StatusImage realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.StatusImage unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.StatusImage();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.StatusImage) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.StatusImage) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_StatusImageRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_StatusImageRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_StatusImageRealmProxyInterface realmSource = (com_dreams_chat_models_StatusImageRealmProxyInterface) realmObject;
