...
public class com_dreams_chat_models_StatusRealmProxy extends com.dreams.chat.models.Status
    implements RealmObjectProxy, com_dreams_chat_models_StatusRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.Status> proxyState;
    private RealmList<com.dreams.chat.models.StatusImage> statusImagesRealmList;

    com_dreams_chat_models_StatusRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.Status>(this);
    ...
    public RealmList<com.dreams.chat.models.StatusImage> realmGet$statusImages() {
        ...
        if (statusImagesRealmList != null) {
            ...
            statusImagesRealmList = new RealmList<com.dreams.chat.models.StatusImage>(com.dreams.chat.models.StatusImage.class, osList, proxyState.getRealm$realm());
            return statusImagesRealmList;
        }
    }
    ...
    public void realmSet$statusImages(RealmList<com.dreams.chat.models.StatusImage> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.dreams.chat.models.StatusImage> original = value;
                value = new RealmList<com.dreams.chat.models.StatusImage>();
                for (com.dreams.chat.models.StatusImage item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.dreams.chat.models.StatusImage linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.Status createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.dreams.chat.models.Status obj = realm.createObjectInternal(com.dreams.chat.models.Status.class, true, excludeFields);

        final com_dreams_chat_models_StatusRealmProxyInterface objProxy = (com_dreams_chat_models_StatusRealmProxyInterface) obj;
        if (json.has("statusImages")) {
            if (json.isNull("statusImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.dreams.chat.models.StatusImage item = com_dreams_chat_models_StatusImageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.dreams.chat.models.Status createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.Status obj = new com.dreams.chat.models.Status();
        final com_dreams_chat_models_StatusRealmProxyInterface objProxy = (com_dreams_chat_models_StatusRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$statusImages(new RealmList<com.dreams.chat.models.StatusImage>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.dreams.chat.models.StatusImage item = com_dreams_chat_models_StatusImageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$statusImages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.dreams.chat.models.Status copyOrUpdate(Realm realm, com.dreams.chat.models.Status object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.Status) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.Status copy(Realm realm, com.dreams.chat.models.Status newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.Status realmObject = realm.createObjectInternal(com.dreams.chat.models.Status.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_StatusRealmProxyInterface realmObjectSource = (com_dreams_chat_models_StatusRealmProxyInterface) newObject;
        com_dreams_chat_models_StatusRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_StatusRealmProxyInterface) realmObject;


        RealmList<com.dreams.chat.models.StatusImage> statusImagesList = realmObjectSource.realmGet$statusImages();
        if (statusImagesList != null) {
            RealmList<com.dreams.chat.models.StatusImage> statusImagesRealmList = realmObjectCopy.realmGet$statusImages();
            statusImagesRealmList.clear();
            for (int i = 0; i < statusImagesList.size(); i++) {
                com.dreams.chat.models.StatusImage statusImagesItem = statusImagesList.get(i);
                com.dreams.chat.models.StatusImage cachestatusImages = (com.dreams.chat.models.StatusImage) cache.get(statusImagesItem);
                if (cachestatusImages != null) {
                    statusImagesRealmList.add(cachestatusImages);
                } else {
                    statusImagesRealmList.add(com_dreams_chat_models_StatusImageRealmProxy.copyOrUpdate(realm, statusImagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.dreams.chat.models.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Status.class);
        long tableNativePtr = table.getNativePtr();
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Status.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.dreams.chat.models.StatusImage> statusImagesList = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$statusImages();
        if (statusImagesList != null) {
            OsList statusImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.statusImagesIndex);
            for (com.dreams.chat.models.StatusImage statusImagesItem : statusImagesList) {
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_dreams_chat_models_StatusImageRealmProxy.insert(realm, statusImagesItem, cache);
                }
                statusImagesOsList.addRow(cacheItemIndexstatusImages);
            }
        }
        String realmGet$lastMessage = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$timeUpdated(), false);

        com.dreams.chat.models.User userObj = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        com.dreams.chat.models.Group groupObj = ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_dreams_chat_models_StatusRealmProxyInterface) object).realmGet$read(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Status.class);
        com.dreams.chat.models.Status object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.Status) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Status.class);
        ...
        if (statusImagesList != null && statusImagesList.size() == statusImagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexstatusImages = cache.get(statusImagesItem);
                if (cacheItemIndexstatusImages == null) {
                    cacheItemIndexstatusImages = com_dreams_chat_models_StatusImageRealmProxy.insertOrUpdate(realm, statusImagesItem, cache);
                }
    ...
    public static com.dreams.chat.models.Status createDetachedCopy(com.dreams.chat.models.Status realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.Status unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.Status();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.Status) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.Status) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_StatusRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_StatusRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_StatusRealmProxyInterface realmSource = (com_dreams_chat_models_StatusRealmProxyInterface) realmObject;

        // Deep copy of statusImages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$statusImages(null);
        } else {
            RealmList<com.dreams.chat.models.StatusImage> managedstatusImagesList = realmSource.realmGet$statusImages();
            RealmList<com.dreams.chat.models.StatusImage> unmanagedstatusImagesList = new RealmList<com.dreams.chat.models.StatusImage>();
            unmanagedCopy.realmSet$statusImages(unmanagedstatusImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedstatusImagesList.size();
            for (int i = 0; i < size; i++) {
                com.dreams.chat.models.StatusImage item = com_dreams_chat_models_StatusImageRealmProxy.createDetachedCopy(managedstatusImagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_dreams_chat_models_StatusRealmProxy aStatus = (com_dreams_chat_models_StatusRealmProxy)o;
