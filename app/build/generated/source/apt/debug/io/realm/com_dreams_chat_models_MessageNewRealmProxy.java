...
public class com_dreams_chat_models_MessageNewRealmProxy extends com.dreams.chat.models.MessageNew
    implements RealmObjectProxy, com_dreams_chat_models_MessageNewRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.MessageNew> proxyState;

    com_dreams_chat_models_MessageNewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.MessageNew>(this);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.MessageNew createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        com.dreams.chat.models.MessageNew obj = realm.createObjectInternal(com.dreams.chat.models.MessageNew.class, true, excludeFields);

        final com_dreams_chat_models_MessageNewRealmProxyInterface objProxy = (com_dreams_chat_models_MessageNewRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
    ...
    public static com.dreams.chat.models.MessageNew createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.MessageNew obj = new com.dreams.chat.models.MessageNew();
        final com_dreams_chat_models_MessageNewRealmProxyInterface objProxy = (com_dreams_chat_models_MessageNewRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.dreams.chat.models.MessageNew copyOrUpdate(Realm realm, com.dreams.chat.models.MessageNew object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.MessageNew) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.MessageNew copy(Realm realm, com.dreams.chat.models.MessageNew newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.MessageNew realmObject = realm.createObjectInternal(com.dreams.chat.models.MessageNew.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_MessageNewRealmProxyInterface realmObjectSource = (com_dreams_chat_models_MessageNewRealmProxyInterface) newObject;
        com_dreams_chat_models_MessageNewRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_MessageNewRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.dreams.chat.models.MessageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.MessageNew.class);
        long tableNativePtr = table.getNativePtr();
        MessageNewColumnInfo columnInfo = (MessageNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.MessageNew.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$recipientId = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$recipientId();
        ...
        String realmGet$id = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.dreams.chat.models.AttachmentList attachmentObj = ((com_dreams_chat_models_MessageNewRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageNewColumnInfo columnInfo = (MessageNewColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.MessageNew.class);
        com.dreams.chat.models.MessageNew object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.MessageNew) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.MessageNew object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.MessageNew.class);
    ...
    public static com.dreams.chat.models.MessageNew createDetachedCopy(com.dreams.chat.models.MessageNew realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.MessageNew unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.MessageNew();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.MessageNew) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.MessageNew) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_MessageNewRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_MessageNewRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_MessageNewRealmProxyInterface realmSource = (com_dreams_chat_models_MessageNewRealmProxyInterface) realmObject;
