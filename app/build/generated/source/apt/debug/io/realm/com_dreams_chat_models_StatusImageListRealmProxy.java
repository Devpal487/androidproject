...
public class com_dreams_chat_models_StatusImageListRealmProxy extends com.dreams.chat.models.StatusImageList
    implements RealmObjectProxy, com_dreams_chat_models_StatusImageListRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.StatusImageList> proxyState;

    com_dreams_chat_models_StatusImageListRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.StatusImageList>(this);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.StatusImageList createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.dreams.chat.models.StatusImageList obj = realm.createObjectInternal(com.dreams.chat.models.StatusImageList.class, true, excludeFields);

        final com_dreams_chat_models_StatusImageListRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageListRealmProxyInterface) obj;
        if (json.has("url")) {
            if (json.isNull("url")) {
    ...
    public static com.dreams.chat.models.StatusImageList createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.StatusImageList obj = new com.dreams.chat.models.StatusImageList();
        final com_dreams_chat_models_StatusImageListRealmProxyInterface objProxy = (com_dreams_chat_models_StatusImageListRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.dreams.chat.models.StatusImageList copyOrUpdate(Realm realm, com.dreams.chat.models.StatusImageList object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.StatusImageList) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.StatusImageList copy(Realm realm, com.dreams.chat.models.StatusImageList newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.StatusImageList realmObject = realm.createObjectInternal(com.dreams.chat.models.StatusImageList.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_StatusImageListRealmProxyInterface realmObjectSource = (com_dreams_chat_models_StatusImageListRealmProxyInterface) newObject;
        com_dreams_chat_models_StatusImageListRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_StatusImageListRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.dreams.chat.models.StatusImageList object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImageList.class);
        long tableNativePtr = table.getNativePtr();
        StatusImageListColumnInfo columnInfo = (StatusImageListColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImageList.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$url = ((com_dreams_chat_models_StatusImageListRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.uploadTimeIndex, rowIndex, ((com_dreams_chat_models_StatusImageListRealmProxyInterface) object).realmGet$uploadTime(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.expiryIndex, rowIndex, ((com_dreams_chat_models_StatusImageListRealmProxyInterface) object).realmGet$expiry(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        StatusImageListColumnInfo columnInfo = (StatusImageListColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.StatusImageList.class);
        com.dreams.chat.models.StatusImageList object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.StatusImageList) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.StatusImageList object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.StatusImageList.class);
    ...
    public static com.dreams.chat.models.StatusImageList createDetachedCopy(com.dreams.chat.models.StatusImageList realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.StatusImageList unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.StatusImageList();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.StatusImageList) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.StatusImageList) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_StatusImageListRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_StatusImageListRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_StatusImageListRealmProxyInterface realmSource = (com_dreams_chat_models_StatusImageListRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_dreams_chat_models_StatusImageListRealmProxy aStatusImageList = (com_dreams_chat_models_StatusImageListRealmProxy)o;
