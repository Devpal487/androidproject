...
public class com_dreams_chat_models_LogCallRealmProxy extends com.dreams.chat.models.LogCall
    implements RealmObjectProxy, com_dreams_chat_models_LogCallRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.LogCall> proxyState;

    com_dreams_chat_models_LogCallRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.LogCall>(this);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.LogCall createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("user")) {
            excludeFields.add("user");
        }
        com.dreams.chat.models.LogCall obj = realm.createObjectInternal(com.dreams.chat.models.LogCall.class, true, excludeFields);

        final com_dreams_chat_models_LogCallRealmProxyInterface objProxy = (com_dreams_chat_models_LogCallRealmProxyInterface) obj;
        if (json.has("user")) {
            if (json.isNull("user")) {
    ...
    public static com.dreams.chat.models.LogCall createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.LogCall obj = new com.dreams.chat.models.LogCall();
        final com_dreams_chat_models_LogCallRealmProxyInterface objProxy = (com_dreams_chat_models_LogCallRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.dreams.chat.models.LogCall copyOrUpdate(Realm realm, com.dreams.chat.models.LogCall object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.LogCall) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.LogCall copy(Realm realm, com.dreams.chat.models.LogCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.LogCall realmObject = realm.createObjectInternal(com.dreams.chat.models.LogCall.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_LogCallRealmProxyInterface realmObjectSource = (com_dreams_chat_models_LogCallRealmProxyInterface) newObject;
        com_dreams_chat_models_LogCallRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_LogCallRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.dreams.chat.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.LogCall.class);
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.LogCall.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        com.dreams.chat.models.User userObj = ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeDurationSecondsIndex, rowIndex, ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$timeDurationSeconds(), false);
        String realmGet$status = ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$myId = ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoIndex, rowIndex, ((com_dreams_chat_models_LogCallRealmProxyInterface) object).realmGet$isVideo(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.LogCall.class);
        com.dreams.chat.models.LogCall object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.LogCall) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.LogCall.class);
    ...
    public static com.dreams.chat.models.LogCall createDetachedCopy(com.dreams.chat.models.LogCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.LogCall unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.LogCall();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.LogCall) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.LogCall) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_LogCallRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_LogCallRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_LogCallRealmProxyInterface realmSource = (com_dreams_chat_models_LogCallRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_dreams_chat_models_LogCallRealmProxy aLogCall = (com_dreams_chat_models_LogCallRealmProxy)o;
