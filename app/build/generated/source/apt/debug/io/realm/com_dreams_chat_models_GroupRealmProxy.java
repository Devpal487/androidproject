...
public class com_dreams_chat_models_GroupRealmProxy extends com.dreams.chat.models.Group
    implements RealmObjectProxy, com_dreams_chat_models_GroupRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.Group> proxyState;
    private RealmList<String> userIdsRealmList;
    private RealmList<String> grpExitUserIdsRealmList;

    com_dreams_chat_models_GroupRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.Group>(this);
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.dreams.chat.models.Group obj = realm.createObjectInternal(com.dreams.chat.models.Group.class, true, excludeFields);

        final com_dreams_chat_models_GroupRealmProxyInterface objProxy = (com_dreams_chat_models_GroupRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.dreams.chat.models.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.Group obj = new com.dreams.chat.models.Group();
        final com_dreams_chat_models_GroupRealmProxyInterface objProxy = (com_dreams_chat_models_GroupRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.dreams.chat.models.Group copyOrUpdate(Realm realm, com.dreams.chat.models.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.Group) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.Group copy(Realm realm, com.dreams.chat.models.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.Group realmObject = realm.createObjectInternal(com.dreams.chat.models.Group.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_GroupRealmProxyInterface realmObjectSource = (com_dreams_chat_models_GroupRealmProxyInterface) newObject;
        com_dreams_chat_models_GroupRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_GroupRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.dreams.chat.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Group.class);
        long tableNativePtr = table.getNativePtr();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Group.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$name = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$status = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$image = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$image();
        if (realmGet$image != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.imageIndex, rowIndex, realmGet$image, false);
        }
        String realmGet$admin = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$admin();
        if (realmGet$admin != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.adminIndex, rowIndex, realmGet$admin, false);
        }

        RealmList<java.lang.String> userIdsList = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$userIds();
        if (userIdsList != null) {
        ...
        RealmList<java.lang.String> grpExitUserIdsList = ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$grpExitUserIds();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_dreams_chat_models_GroupRealmProxyInterface) object).realmGet$date(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Group.class);
        com.dreams.chat.models.Group object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.Group) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Group.class);
    ...
    public static com.dreams.chat.models.Group createDetachedCopy(com.dreams.chat.models.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.Group unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.Group();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.Group) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.Group) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_GroupRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_GroupRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_GroupRealmProxyInterface realmSource = (com_dreams_chat_models_GroupRealmProxyInterface) realmObject;
