...
public class com_dreams_chat_models_MessageRealmProxy extends com.dreams.chat.models.Message
    implements RealmObjectProxy, com_dreams_chat_models_MessageRealmProxyInterface {
    ...
    private ProxyState<com.dreams.chat.models.Message> proxyState;
    private RealmList<String> userIdsRealmList;
    private RealmList<String> grpDeletedMsgIdsRealmList;

    com_dreams_chat_models_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.dreams.chat.models.Message>(this);
    ...
    @Override
    public com.dreams.chat.models.Attachment realmGet$attachment() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.attachmentIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.dreams.chat.models.Attachment.class, proxyState.getRow$realm().getLink(columnInfo.attachmentIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$attachment(com.dreams.chat.models.Attachment value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.dreams.chat.models.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.dreams.chat.models.Message obj = realm.createObjectInternal(com.dreams.chat.models.Message.class, true, excludeFields);

        final com_dreams_chat_models_MessageRealmProxyInterface objProxy = (com_dreams_chat_models_MessageRealmProxyInterface) obj;
        if (json.has("body")) {
            if (json.isNull("body")) {
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                com.dreams.chat.models.Attachment attachmentObj = com_dreams_chat_models_AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
    ...
    public static com.dreams.chat.models.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.dreams.chat.models.Message obj = new com.dreams.chat.models.Message();
        final com_dreams_chat_models_MessageRealmProxyInterface objProxy = (com_dreams_chat_models_MessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.dreams.chat.models.Attachment attachmentObj = com_dreams_chat_models_AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$attachment(attachmentObj);
                }
    ...
    public static com.dreams.chat.models.Message copyOrUpdate(Realm realm, com.dreams.chat.models.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.dreams.chat.models.Message) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.dreams.chat.models.Message copy(Realm realm, com.dreams.chat.models.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.dreams.chat.models.Message realmObject = realm.createObjectInternal(com.dreams.chat.models.Message.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_dreams_chat_models_MessageRealmProxyInterface realmObjectSource = (com_dreams_chat_models_MessageRealmProxyInterface) newObject;
        com_dreams_chat_models_MessageRealmProxyInterface realmObjectCopy = (com_dreams_chat_models_MessageRealmProxyInterface) realmObject;
        ...
        com.dreams.chat.models.Attachment attachmentObj = realmObjectSource.realmGet$attachment();
        if (attachmentObj == null) {
            realmObjectCopy.realmSet$attachment(null);
        } else {
            com.dreams.chat.models.Attachment cacheattachment = (com.dreams.chat.models.Attachment) cache.get(attachmentObj);
            if (cacheattachment != null) {
                realmObjectCopy.realmSet$attachment(cacheattachment);
            } else {
                realmObjectCopy.realmSet$attachment(com_dreams_chat_models_AttachmentRealmProxy.copyOrUpdate(realm, attachmentObj, update, cache));
            }
        }
    ...
    public static long insert(Realm realm, com.dreams.chat.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Message.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$body = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$senderName = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderId = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }
        String realmGet$recipientId = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$recipientId();
        ...
        String realmGet$id = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$statusUrl = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$statusUrl();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.dreams.chat.models.Attachment attachmentObj = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_dreams_chat_models_AttachmentRealmProxy.insert(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readMsgIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$readMsg(), false);
        String realmGet$replyId = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$replyId();
        if (realmGet$replyId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.replyIdIndex, rowIndex, realmGet$replyId, false);
        }
        String realmGet$delete = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$delete();
        if (realmGet$delete != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.deleteIndex, rowIndex, realmGet$delete, false);
        }

        RealmList<java.lang.String> userIdsList = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$userIds();
        if (userIdsList != null) {
        ...
        RealmList<java.lang.String> grpDeletedMsgIdsList = ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$grpDeletedMsgIds();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBlockedIndex, rowIndex, ((com_dreams_chat_models_MessageRealmProxyInterface) object).realmGet$isBlocked(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.dreams.chat.models.Message.class);
        com.dreams.chat.models.Message object = null;
        while (objects.hasNext()) {
            object = (com.dreams.chat.models.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.dreams.chat.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.dreams.chat.models.Message.class);
        ...
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_dreams_chat_models_AttachmentRealmProxy.insertOrUpdate(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        } else {
    ...
    public static com.dreams.chat.models.Message createDetachedCopy(com.dreams.chat.models.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.dreams.chat.models.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.dreams.chat.models.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.dreams.chat.models.Message) cachedObject.object;
            }
            unmanagedObject = (com.dreams.chat.models.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_dreams_chat_models_MessageRealmProxyInterface unmanagedCopy = (com_dreams_chat_models_MessageRealmProxyInterface) unmanagedObject;
        com_dreams_chat_models_MessageRealmProxyInterface realmSource = (com_dreams_chat_models_MessageRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$attachment(com_dreams_chat_models_AttachmentRealmProxy.createDetachedCopy(realmSource.realmGet$attachment(), currentDepth + 1, maxDepth, cache));
